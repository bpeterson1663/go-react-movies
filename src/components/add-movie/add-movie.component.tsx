    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
                ...
                <input type="text" className="form-control" id="runtime" name="runtime" value={movie.runtime} onChange={handleInputChange}/>
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
                ...
                <textarea className="form-control" rows={3} id="description" name="description" onChange={handleTextareaChange} value={movie.description} />
            </div>
            <hr />
